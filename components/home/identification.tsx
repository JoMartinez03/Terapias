...
const items: IdentificationItem[] = [
  ...
  {
    icon: MoonIcon,
    text: "Sentís estancamiento, agotamiento o desconexión.",
  },
  {
    icon: WaveIcon,
...
export function Identification() {
  return (
    <section id="identificacion" className="bg-background">
      <div className="wrap py-16 md:py-24 lg:py-28">
          ...
          {items.map((item, i) => {
            ...
            return (
              <Reveal key={item.text} delay={i * 70} role="listitem">
                <article className="flex h-full flex-col items-start gap-4 rounded-2xl border border-rose/30 bg-surface p-6 transition-all duration-300 hover:-translate-y-1 hover:border-rose/70 hover:shadow-lg">
        ...
        <Reveal delay={200}>
          <p className="mx-auto mt-16 max-w-xl text-center font-serif text-2xl italic leading-snug text-ink md:text-3xl">
            Eso no es casualidad. Y no tenés que cargarlo en soledad.
          </p>
        </Reveal>
      </div>
    </section>
